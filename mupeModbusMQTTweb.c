...
httpd_uri_t modbus_uri_get = { .uri = "/modbus/*", .method = HTTP_GET, .handler =
		root_modbus_get_handler };

httpd_uri_t modbus_uri_post = { .uri = "/modbus/*", .method = HTTP_POST, .handler =
		root_modbus_post_handler, .user_ctx = NULL };
